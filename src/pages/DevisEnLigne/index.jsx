    ...
    return (
        <div className='main'>
          <Banner 
            ...
            />
          <section>
            <h2>Demandez votre Intervention ou Devis en ligne: Simple, Rapide et Efficace</h2>
            ...
            <div className='container__devis'>
              <div className='devis__content'>
                <div className='devis__content-text'>
                  <p>Vous pouvez maintenant faire vos demandes de devis ou d'intervention en ligne depuis votre smartphone, tablette ou ordinateur en quelques clics.</p>
