...
const Faq = () => {
  ...
  const FaqData = [
    ...
    {
      title: "Quels types d'aides financières sont disponibles pour l'installation ?",
      content: [
    ...
    },
    {
      ...
      content: [
        "Le coût d'une installation de pompe à chaleur varie en fonction de la taille de votre maison, du type de pompe à chaleur (air/eau, géothermique), et de vos besoins spécifiques. En moyenne, une installation complète peut coûter entre 8 000€ et 15 000€, avant aides financières."
      ],
      icon: faCircleQuestion
    },
    {
    ...
    },
    {
      ...
      content: [
        "L'installation d'une pompe à chaleur nécessite des travaux modérés. Nous nous assurons que l'impact sur votre maison est minimal et que les installations sont réalisées dans les délais convenus."
      ],
      icon: faCircleQuestion
    },
    {
